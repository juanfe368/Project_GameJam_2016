...
public class BotControlScript : MonoBehaviour
{
	...
	void FixedUpdate ()
	{
		float h = Input.GetAxis("Vertical");				// setup h variable as our horizontal input axis significa que Vertica es tecla arriba y abajo
		float v = Input.GetAxis("Horizontal"); 			// setup v variables as our vertical input axis Horizantal es teclas izquierda y derecha
